<template>
  <AdminLayout pageTitle="Dashboard">
    <div class="container mx-auto px-4 py-8">
      <!-- Header Section -->
      <div class="mb-8">
        <h1 :class="['text-3xl font-bold', isDarkMode ? 'text-white' : 'text-gray-900']">Admin Dashboard</h1>
        ...
        <div :class="[
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p :class="['text-2xl font-bold mt-1', isDarkMode ? 'text-white' : 'text-gray-900']">
            ...
            <div :class="[
              ...
              <Users :class="['h-6 w-6', isDarkMode ? 'text-blue-400' : 'text-blue-600']" />
            </div>
          </div>
        </div>
        ...
        <div :class="[
          ...
          <div class="flex items-center justify-between">
            ...
            <div :class="[
              ...
              <UserCheck :class="['h-6 w-6', isDarkMode ? 'text-green-400' : 'text-green-600']" />
            </div>
          </div>
        </div>
        ...
        <div :class="[
          ...
          <div class="flex items-center justify-between">
            ...
            <div :class="[
              ...
              <FileQuestion :class="['h-6 w-6', isDarkMode ? 'text-purple-400' : 'text-purple-600']" />
            </div>
          </div>
        </div>
        ...
        <div :class="[
          ...
          <div class="flex items-center justify-between">
            ...
            <div :class="[
              ...
              <TrendingUp :class="['h-6 w-6', isDarkMode ? 'text-orange-400' : 'text-orange-600']" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div :class="[
          ...
          <div class="space-y-4">
            <div v-for="day in completionData" :key="day.date" class="flex items-center gap-4">
              <span :class="['text-sm w-16', isDarkMode ? 'text-gray-400' : 'text-gray-600']">
                {{ day.date }}
              </span>
              <div class="flex-1">
                <div :class="[
              ...
              <span :class="['text-sm w-20 text-right', isDarkMode ? 'text-gray-400' : 'text-gray-600']">
