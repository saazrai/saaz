            ...
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Enter the permission details below. The permission will be available for assignment to roles.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form @submit.prevent="submit" class="space-y-6">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                        Usually "web" for web applications. Leave empty to use default.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                        Select which roles should automatically have this permission.
                                    </p>
                                </div>
                            </div>
...
const submit = () => {
    ...
    router.post(safeRoute('admin.permissions.store'), form.value, {
        onFinish: () => {
