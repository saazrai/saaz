        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-xs border border-gray-200 p-6 mb-8">
                ...
                <div class="w-full bg-gray-200 rounded-full h-2">
                    <div class="bg-linear-to-r from-blue-600 to-purple-600 h-2 rounded-full transition-all duration-500"
                         :style="`width: ${progress}%`"></div>
                </div>
            </div>

            <!-- Question Card -->
            <div class="bg-white rounded-2xl shadow-xs border border-gray-200 p-8 mb-8">
                <div class="mb-8">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-4">
                    ...
                    <Button v-else 
                            ...
                            class="px-8 py-3 bg-linear-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
