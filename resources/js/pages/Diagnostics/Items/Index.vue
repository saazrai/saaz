                    ...
                    <form @submit.prevent="submit" class="mb-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <textarea v-model="form.question" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Dimension</label>
                                <select v-model="form.dimension" class="mt-1 block w-full rounded-md border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <div v-for="(option, index) in form.options" :key="index" class="flex gap-2 mt-2">
                                    <input v-model="form.options[index]" type="text" class="flex-1 rounded-md border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <div v-for="(answer, index) in form.correct_answer" :key="index" class="flex gap-2 mt-2">
                                    <input v-model="form.correct_answer[index]" type="text" class="flex-1 rounded-md border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <select v-model="form.status" class="mt-1 block w-full rounded-md border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500">
