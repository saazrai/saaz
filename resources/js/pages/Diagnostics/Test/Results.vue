                ...
                <Card class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800 border-blue-200 dark:border-gray-700 shadow-lg">
                    ...
                    <CardContent>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <Link 
                                :href="route('assessments.diagnostics.review', diagnostic.id)" 
                            ...
                            <Link 
                                :href="route('assessments.diagnostics.report', diagnostic.id)"
                            ...
                            <Link 
                                :href="typeof route !== 'undefined' ? route('assessments.diagnostics.enhanced-report', diagnostic.id) : '#'"
                            ...
                            <Link 
                                :href="route('learn.courses.index')"
                            ...
                            <Link 
                                :href="route('assessments.diagnostics.dashboard')" 
                                class="inline-flex items-center px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg shadow-md transition-colors"
                            >
