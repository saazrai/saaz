                            ...
                            <Dropdown align="right" :contentClasses="`py-0 ${isDark ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-lg min-w-[220px] max-w-[90vw] z-50`" ref="userDropdown" width="auto">
                                ...
                                <template #content>
                                    ...
                                    <div class="py-2">
                                        ...
                                        <Link v-if="$page.props.auth.roles && ($page.props.auth.roles.includes('admin') || $page.props.auth.roles.includes('super-admin') || $page.props.auth.roles.includes('moderator'))" 
