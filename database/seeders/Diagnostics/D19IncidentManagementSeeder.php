...
class D19IncidentManagementSeeder extends BaseDiagnosticSeeder
{
    ...
    protected function getQuestions(): array
    {
        return [
            ...
            [
                'subtopic' => 'Preparation',
                'question' => 'Why is it important to define incident classification criteria in advance?',
                'options' => [
                    'To reduce paperwork during incident response',
                    'To ensure consistent priority assignment and appropriate resource allocation',
                    'To limit liability in case of legal action',
                    'To satisfy audit requirements only'
                ],
                'correct_options' => ['To ensure consistent priority assignment and appropriate resource allocation'],
                'justifications' => [
                    'Incorrect - This option is not the best answer',
                    'Correct - To ensure consistent priority assignment and appropriate resource allocation',
                    'Incorrect - This option is not the best answer',
                    'Incorrect - This option is not the best answer'
                ],
                'type_id' => 1,
            ...
            [
                'subtopic' => 'Detection, Triage & Analysis',
                'question' => 'Why is it important to establish a baseline of normal network activity before implementing anomaly detection?',
                'options' => [
                    'To reduce system processing requirements',
                    'To distinguish between normal variations and genuine security incidents',
                    'To comply with regulatory requirements',
                    'To reduce false positive alerts to zero'
                ],
                'correct_options' => ['To distinguish between normal variations and genuine security incidents'],
                'justifications' => [
                    'Incorrect - This option is not the best answer',
                    'Correct - To distinguish between normal variations and genuine security incidents',
                    'Incorrect - This option is not the best answer',
                    'Incorrect - This option is not the best answer'
                ],
                'type_id' => 1,
            ...
            [
                'subtopic' => 'Detection, Triage & Analysis',
                'question' => 'A security analyst receives an alert about unusual outbound network traffic from a database server at 3 AM. What should be the first step in analysis?',
                'options' => [
                    'Immediately disconnect the server from the network',
                    'Gather additional context including traffic details, user activity, and system logs',
                    'Notify senior management about a confirmed breach',
                    'Run antivirus scans on all connected systems'
                ],
                'correct_options' => ['Gather additional context including traffic details, user activity, and system logs'],
                'justifications' => [
                    'Incorrect - This option is not the best answer',
                    'Correct - Gather additional context including traffic details, user activity, and system logs',
                    'Incorrect - This option is not the best answer',
                    'Incorrect - This option is not the best answer'
                ],
                'type_id' => 1,
            ...
            [
                ...
                'question' => 'What is the primary goal of incident containment?',
                'options' => [
                ...
                'correct_options' => ['To limit the scope and impact of the incident'],
                'justifications' => [
                    'Incorrect - This option is not the best answer',
                    'Correct - To limit the scope and impact of the incident',
                    'Incorrect - This option is not the best answer',
                    'Incorrect - This option is not the best answer'
                ],
                'type_id' => 1,
            ...
            [
                'subtopic' => 'Post-Incident Activity',
                'question' => 'When conducting root cause analysis after a security incident, what approach provides the most comprehensive understanding?',
                'options' => [
                    'Focus only on the immediate technical vulnerability',
                    'Examine technical, process, and human factors that contributed to the incident',
                    'Only analyze the attacker\'s techniques',
                    'Limit analysis to the affected system'
                ],
                'correct_options' => ['Examine technical, process, and human factors that contributed to the incident'],
                'justifications' => [
                    'Incorrect - This option is not the best answer',
                    'Correct - Examine technical, process, and human factors that contributed to the incident',
                    'Incorrect - This option is not the best answer',
                    'Incorrect - This option is not the best answer'
                ],
                'type_id' => 1,
