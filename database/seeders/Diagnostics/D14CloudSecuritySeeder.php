...
class D14CloudSecuritySeeder extends BaseDiagnosticSeeder
{
    ...
    protected function getQuestions(): array
    {
        return [
            ...
            [
                'subtopic' => 'Cloud Models',
                'question' => 'A multinational organization is planning to migrate its on-premises IT infrastructure to a hybrid cloud environment. To ensure compliance with global regulatory requirements, it has engaged a third-party entity to manage contractual obligations between the cloud service provider (CSP) and the cloud service customer (CSC). The third-party entity is also responsible for integrating services from multiple CSPs to optimize costs and improve service delivery. Which cloud computing role best describes this third-party entity?',
                'options' => [
                ...
                'correct_options' => ['Cloud Service Broker'],
                'justifications' => [
                    'Incorrect - Cloud Service Partners provide complementary services but do not manage contractual obligations or integrate multiple CSPs',
                    'Correct - Cloud Service Broker acts as an intermediary that manages relationships between CSPs and CSCs, integrates multiple provider services, and handles contractual obligations',
                    'Incorrect - Cloud Service Provider delivers the actual cloud services, not intermediary management services',
                    'Incorrect - Regulators establish compliance requirements but do not manage commercial relationships between cloud entities',
                ],
                'bloom_level' => 1,
                'difficulty_level' => 1,
                'type_id' => 1,
            ...
            [
                'subtopic' => 'Cloud Models',
                'question' => 'A company wants exclusive access to and usage of its computing infrastructure but prefers the environment to be managed and hosted by a third-party provider rather than on-premises. Which cloud deployment model does this scenario BEST describe?',
                'options' => [
                    'Public Cloud',
                    'Private Cloud',
                    'Community Cloud',
                ...
                'justifications' => [
                    'Incorrect - Public Cloud involves shared resources among multiple organizations, not exclusive access',
                    'Correct - Private Cloud provides exclusive access to computing resources for a single organization and can be hosted by a third-party provider',
                    'Incorrect - Community Cloud is shared among organizations with common interests, not exclusive to one company',
                    'Incorrect - Hybrid Cloud combines multiple deployment models, but this scenario describes a single exclusive model',
                ],
                'bloom_level' => 1,
                'difficulty_level' => 1,
                'type_id' => 1,
            ...
            [
                'subtopic' => 'Cloud Models',
                'question' => 'What is the primary purpose of using a community cloud?',
                'options' => [
                ...
                'correct_options' => ['Address shared concerns'],
                'justifications' => [
                    'Correct - Community cloud is specifically designed to serve organizations with shared concerns, compliance requirements, or common interests',
                    'Incorrect - While cost may be a benefit, cost minimization is not the primary purpose of community cloud',
                    'Incorrect - Security improvement may result but is not the primary purpose; community clouds address shared requirements',
                    'Incorrect - Scalability can be achieved through various cloud models; community cloud is specifically about shared concerns',
                ],
                'bloom_level' => 1,
                'difficulty_level' => 1,
                'type_id' => 1,
            ...
            [
                'subtopic' => 'Cloud Models',
                'question' => 'A company is considering using an intermediary service to facilitate the connection between its data centers and various cloud service providers (CSPs). This service will handle the secure transmission of data, service orchestration, and ensure reliable connectivity. What role does this intermediary play in the cloud architecture?',
                'options' => [
                    'Cloud Broker',
                    'Cloud Carrier',
                    'Cloud Auditor',
                ...
                'correct_options' => ['Cloud Carrier'],
                'justifications' => [
                    'Incorrect - Cloud Broker manages service relationships and integration but does not provide the actual network connectivity and data transmission',
                    'Correct - Cloud Carrier provides the network connectivity, data transmission, and transport services between cloud consumers and cloud service providers',
                    'Incorrect - Cloud Auditor conducts independent assessments and compliance verification but does not provide connectivity services',
                    'Incorrect - Cloud Orchestrator is not a standard cloud computing role; orchestration is typically a function within cloud management platforms',
                ],
                'bloom_level' => 2,
                'difficulty_level' => 2,
                'type_id' => 1,
            ...
            [
                'subtopic' => 'Cloud Models',
                'question' => 'Which of the following statements about a Virtual Private Cloud (VPC) is most accurate?',
                'options' => [
                    'A VPC is a physically isolated section of the cloud where users can deploy cloud resources in complete physical isolation.',
                    'A VPC provides network isolation using virtualization, but it shares the underlying physical infrastructure with other tenants.',
                    'A VPC guarantees that resources are not shared with any other customer, including compute and network hardware.',
                    'A VPC requires dedicated physical hardware and cannot be created in a shared cloud environment.',
                ],
                'correct_options' => ['A VPC provides network isolation using virtualization, but it shares the underlying physical infrastructure with other tenants.'],
                'justifications' => [
                    'Incorrect - VPC provides logical isolation through virtualization, not complete physical isolation',
                    'Correct - VPC uses virtualization technologies to create network isolation while sharing the underlying physical infrastructure with other tenants in a multi-tenant cloud environment',
                    'Incorrect - VPC provides network isolation but compute and network hardware are typically shared in public cloud environments',
                    'Incorrect - VPC can be created in shared cloud environments; dedicated hardware is not required for VPC implementation',
                ],
                'bloom_level' => 2,
                'difficulty_level' => 3,
                'type_id' => 1,
